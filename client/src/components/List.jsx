...
import { addList, deleteList, loadMasterList, updateList } from './part3Slice'
import { useNavigate } from 'react-router-dom'
import axios from 'axios'
import Back from './Back'

// Page that shows every quote collection
// Option to upload / download any lists JSON.
// Or to download the master lists which contains everything, or to upload one to override everything.
...
export default function List() {
  ...
  const ListCard = ({ name, quant, index }) => {
    return (
      <div className='list-card' onClick={() => navigate("/list/" + index)}>
